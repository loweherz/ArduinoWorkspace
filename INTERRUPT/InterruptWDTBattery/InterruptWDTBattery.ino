...
float ratio = 2.1107954545454545454545454545455;        // Change this to match the MEASURED ration of the circuit
int ledBattery = 7;
...
void loop(){
  ...
  if (f_wdt==1) {  // wait for timed out watchdog / flag is set when a watchdog timeout occurs
    ...
    ///// debuging purpose only /////
     ...
     Serial.print(" ");
     Serial.println(time);
     delay(59); //needed for serial.print operation to finish
      ////////////////////////////////////
